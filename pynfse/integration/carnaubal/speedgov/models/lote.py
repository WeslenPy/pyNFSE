...
from pynfse.integration.carnaubal.speedgov.constants import ENVIO_NS, TIPOS_NS
from pynfse.integration.carnaubal.speedgov.models.base import SpeedGovNode
